...
;(function () {
    ...
    var AlloyFinger = function (el, option, transform) {
        this.element = typeof el === 'string' ? document.querySelector(el) : el;
        if (transform) this.transform(this.element);
    ...
    AlloyFinger.prototype = {
        ...
        move: function (evt) {
            ...
            this._cancelLongTap();
            if (this.isMulti && evt.touches.length < 2) {
            ...
            if ((this.x2 && Math.abs(this.x1 - this.x2) > 30) ||
                ...
                this.swipeTimeout = setTimeout(function () {
                    this.swipe.dispatch(evt, this.element);
                }.bind(this), 0)
            } else {
        ...
        transform: function (element, notPerspective) {
            observe(
                element,
