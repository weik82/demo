(function ($, undefined) {
    function videoPlayer() {
        ...
        let changeSecond = function (value) {
        ...
        let dragControl = function () { //拖动元素、进度条元素、拖动总长
            let startX = 0,
                moveX = 0,
                disX = 0,
                dragDis = 0,
        ...
        let soundChangeProcess = function (soundValue) {
    ...
    function ifState() {
        let state = videoSource.readyState
        if (state === 4) {
            videoPlayer()
        } else {
            $('.play-sym-wrapper').remove()
