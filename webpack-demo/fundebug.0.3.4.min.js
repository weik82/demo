!(function(e) {
  ...
  function g(t) {
    ...
    console[t] = function() {
      ...
      if ((L.silentConsole || f(n), 'function' == typeof r))
  ...
  (L.silent = D.getAttribute('silent') || !1),
    ...
    (L.silentConsole =
      L.silentConsole || D.getAttribute('silentConsole') || !1),
  ...
  e.history.pushState = function() {
    ...
    var t = {};
    if (
      (3 === arguments.length && (t.url = arguments[2]),
      M.url !== t.url && d(M, t),
      S)
    )
  ...
  e.onhashchange = function() {
    var t = { url: e.location.href, title: document.title };
    if ((M.url !== t.url && d(M, t), A)) return A.apply(this, arguments);
  };
  for (
    var j = ['log', 'warn', 'error', 'debug', 'info'], q = 0;
    q < j.length;
    q++
  )
    e.console && g(j[q]);
    ...
    _.send = function() {
      ...
      (t.onreadystatechange = function() {
        if (4 === t.readyState && !t.Fundebug && X != k) {
          ...
          if (v(a)) {
            var i = { method: a.detail.method, url: a.detail.url },
              o = {
                status: t.status,
                statusText: t.statusText,
                response: t.response,
  ...
  if (e.fetch) {
    ...
    e.fetch = function(t, r) {
      ...
      return U.apply(this, arguments).then(function(t) {
        ...
        if (v(i)) {
          var o = { method: i.detail.method, url: i.detail.url },
            u = { status: t.status, statusText: t.statusText, elapsedTime: a };
